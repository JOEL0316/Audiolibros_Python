      ...
      >
        ...
        <div className="settings__group">
          ...
          >
            ...
            <option value="server">Servidor (audio de fondo + pantalla de bloqueo)</option>
          </select>
          <p className="settings__status" style={{ marginTop: '0.35rem', color: 'var(--text-muted)' }}>
            Para audio en segundo plano instala la PWA y usa modo Servidor con backend activo.
          </p>
